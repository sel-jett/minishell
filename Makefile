...
SRCS = ./parcing/allocation_free/creation1.c ./parcing/allocation_free/my_malloc.c main.c ./parcing/add_in_list/plant_4.c\
	   ...
	   ./execution/execution.c ./execution/execute_utils.c ./execution/execute_utils_2.c ./execution/utils_2.c ./execution/execute.c ./execution/pipe.c ./execution/or.c ./execution/subshell.c \
	   ...
	   ./expanding/expand.c ./expanding/ft_itoa.c ./execution/utils.c ./execution/wildcard.c ./execution/wild.c \
